 ...
 * Extension entity
 *
 * @package Sw\DatabaseConfigBundle\Entity
 *
...
class Extension
{
     ...
     * Add configs
     *
     * @param \Sw\DatabaseConfigBundle\Entity\Config $config the root configuration node attached to the extension
     *
     * @return Extension
     */
    public function addConfig(\Sw\DatabaseConfigBundle\Entity\Config $config)
    {
     ...
     * Remove configs
     *
     * @param \Sw\DatabaseConfigBundle\Entity\Config $configs the root node of the configuration to remove
     *
     * @return void
     */
    public function removeConfig(\Sw\DatabaseConfigBundle\Entity\Config $configs)
    {
